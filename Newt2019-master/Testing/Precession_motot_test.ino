...
#define Prec1_PWM 7
#define Prec2_PWM 6
#define PREC_MAX_TORQUE 66.68f // from datasheet 
...
void loop()
{
    int pwm_1 = 500; // 500 for pwm 1 to 267 for pwm 2 is the ratio for equal speed.
    int pwm_2 = 500;
    Serial.println("Rotating same direction ClockWise 4rpm:");
    digitalWrite(Prec1_DIR,HIGH);    //Sets Precession motor 1 direction to CW
    digitalWrite(Prec2_DIR,HIGH);    //Sets Precession motor 2 direction to CW
    analogWrite(Prec1_PWM, pwm_1);
    ...
    Serial.println("Rotating same direction Counter ClockWise 4rpm:");
    digitalWrite(Prec1_DIR,HIGH);    //Sets Precession motor 1 direction to CW
    digitalWrite(Prec2_DIR,LOW);    //Sets Precession motor 2 direction to CW
    analogWrite(Prec1_PWM, pwm_1);
    analogWrite(Prec2_PWM, pwm_2);
